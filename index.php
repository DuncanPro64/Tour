...
//include "databaseService/database.php";
...
<div class="container">
 ...
 <?php while ($row=mysqli_fetch_array($result)){
  ...
  <a href='components/details.php?service_Id=<?php echo $row['service_Id'] ; ?>' class="btn btn-success" style="height: 40px; width: 100px; border-radius: 100px;" >  DETAILS</a>
      </div >
    </div>
